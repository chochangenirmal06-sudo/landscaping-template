...
export default function ContactPage() {
  ...
  const fieldStyle = (name: string): React.CSSProperties => ({
    width: '100%',
    background: '#FFFFFF',
    border: `1px solid ${errors[name as ScalarField] ? '#e53e3e' : focused === name ? '#B8902A' : 'rgba(28,43,26,0.15)'}`,
    borderRadius: '8px',
    padding: '14px 16px',
    fontSize: '14px',
    color: '#1C2B1A',
    ...
    outline: 'none',
    boxShadow: focused === name ? '0 0 0 3px rgba(184,144,42,0.1)' : 'none',
    ...
    try {
      const response = await fetch('/api/contact', {
        ...
        body: JSON.stringify({
          ...
          spaceToLandscape:  form.spaceSize,
  ...
  const SECTION_LABEL: React.CSSProperties = {
    fontSize: '11px', fontWeight: 700, color: '#1C2B1A',
    textTransform: 'uppercase', letterSpacing: '0.15em',
    borderBottom: '2px solid #1C2B1A', paddingBottom: '8px',
    margin: '28px 0 20px', display: 'block',
    fontFamily: 'var(--font-dmsans), system-ui, sans-serif',
  };

  const FIELD_LABEL: React.CSSProperties = {
    fontSize: '12px', fontWeight: 600, color: '#1C2B1A',
  ...
  return (
    <>
      ...
      <section style={{ background: '#F5F0E8', padding: '80px 0 100px' }}>
        <div
          className="contact-outer"
          style={{ maxWidth: '1200px', margin: '0 auto', padding: '0 60px', boxSizing: 'border-box' }}
        >
          <div
            className="contact-columns"
            style={{ display: 'grid', gridTemplateColumns: '38% 62%', gap: '80px', alignItems: 'start' }}
          >
            ...
            <div>
              <h2
                style={{
                  fontFamily: "var(--font-cormorant), 'Cormorant Garamond', serif",
                  fontSize: '28px', fontWeight: 600, color: '#1C2B1A', marginBottom: '12px',
                }}
              >
                Contact Information
              </h2>
              ...
              <p
                style={{
                  fontSize: '15px', color: '#6B7280', lineHeight: 1.7, marginBottom: '32px',
                  fontFamily: 'var(--font-dmsans), system-ui, sans-serif',
                }}
              >
              ...
              {CONTACT_CARDS.map(({ Icon, label, value, sub, href }) => {
                const inner = (
                  ...
                  >
                    ...
                    >
                      <Icon size={18} style={{ color: '#1C2B1A' }} />
                    </div>
                    <div>
                      <span
                        style={{
                      ...
                      <span
                        style={{
                          fontSize: '15px', color: '#1C2B1A', fontWeight: 600, display: 'block',
                          fontFamily: 'var(--font-dmsans), system-ui, sans-serif',
                        }}
                      >
                        {value}
                      ...
                      {sub && (
                        <span
                          style={{
                            fontSize: '13px', color: '#6B7280', display: 'block', marginTop: '2px',
                            fontFamily: 'var(--font-dmsans), system-ui, sans-serif',
                          }}
                        >
                          {sub}
            ...
            <div>
              <h2
                style={{
                  fontFamily: "var(--font-cormorant), 'Cormorant Garamond', serif",
                  fontSize: '28px', fontWeight: 600, color: '#1C2B1A', marginBottom: '8px',
                }}
              >
              ...
              <p
                style={{
                  fontSize: '14px', color: '#6B7280', marginBottom: '32px', lineHeight: 1.6,
                  fontFamily: 'var(--font-dmsans), system-ui, sans-serif',
                }}
              >
              ...
              <form onSubmit={handleSubmit} noValidate>
                  ...
                  <div style={{ marginBottom: '16px' }}>
                    ...
                    <input
                      ...
                      autoComplete="name" value={form.fullName} onChange={handleChange}
                      {...bind('fullName')}
                    />
                  ...
                  <div className="field-row-2" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '12px', marginBottom: '16px' }}>
                    ...
                    <div>
                      ...
                      <input
                        type="tel" name="phone" placeholder="(512) 555-1234"
                        autoComplete="tel" value={form.phone} onChange={handlePhone}
                        {...bind('phone')}
                      />
                  ...
                  <div style={{ marginBottom: '16px' }}>
                    ...
                    <input
                      type="text" name="streetAddress" placeholder="123 Main St"
                      autoComplete="street-address" value={form.streetAddress} onChange={handleChange}
                      {...bind('streetAddress')}
                    />
                  ...
                  <div style={{ marginBottom: '16px' }}>
                    ...
                    <select
                      ...
                      style={selectStyle('service', !!form.service)}
                    >
                  ...
                  <div className="field-row-2" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '12px', marginBottom: '16px' }}>
                    <div>
                      ...
                      <select
                        name="spaceSize" value={form.spaceSize} onChange={handleChange}
                        onFocus={() => setFocused('spaceSize')} onBlur={() => setFocused(null)}
                        style={selectStyle('spaceSize', !!form.spaceSize)}
                      >
                        <option value="" disabled style={{ color: '#9CA3AF' }}>Select approximate size...</option>
                        {['Under 500 sq ft', '500–1,000 sq ft', '1,000–2,500 sq ft', '2,500–5,000 sq ft', '5,000+ sq ft']
                    ...
                    <div>
                      ...
                      <select
                        name="timeframe" value={form.timeframe} onChange={handleChange}
                        onFocus={() => setFocused('timeframe')} onBlur={() => setFocused(null)}
                        style={selectStyle('timeframe', !!form.timeframe)}
                      >
                  ...
                  <div style={{ marginBottom: '16px' }}>
                    ...
                    <select
                      ...
                      style={selectStyle('budget', !!form.budget)}
                    >
                      <option value="" disabled style={{ color: '#9CA3AF' }}>Select budget range...</option>
                      {['Under $1,000', '$1,000–$3,000', '$3,000–$7,500', '$7,500–$15,000', '$15,000–$30,000', '$30,000+', 'Not sure yet']
                        .map(s => <option key={s} value={s}>{s}</option>)}
                    </select>
                  ...
                  <div style={{ marginBottom: '16px' }}>
                    ...
                    <textarea
                      name="issues"
                      placeholder="e.g., Poor drainage, dead lawn, overgrown beds, no privacy, too much sun..."
                      value={form.issues} onChange={handleChange}
                      onFocus={() => setFocused('issues')} onBlur={() => setFocused(null)}
                      className="light-placeholder"
                      style={{ ...fieldStyle('issues'), resize: 'vertical', minHeight: '100px' }}
                    />
                  </div>
                  ...
                  <div style={{ marginTop: '20px' }}>
                    ...
                    <textarea
                      ...
                      placeholder="Tell us anything else about your vision, must-haves, or concerns..."
                      value={form.additionalDetails} onChange={handleChange}
                      onFocus={() => setFocused('additionalDetails')} onBlur={() => setFocused(null)}
                      className="light-placeholder"
                      style={{ ...fieldStyle('additionalDetails'), resize: 'vertical', minHeight: '120px' }}
                    />
                  </div>
                  ...
                  <button
                    ...
                    style={{
                      width: '100%',
                      background: isSubmitting ? '#9A7820' : '#B8902A',
                      color: '#1C2B1A',
                    ...
                    {isSubmitting ? (
                      <>
                        ...
                        >
                          ...
                          <path d="M8 2 A6 6 0 0 1 14 8" stroke="#1C2B1A" strokeWidth="2.5" strokeLinecap="round" />
                        </svg>
                        SENDING...
                      </>
                    ) : (
      ...
      <style>{`
        ...
        .gold-btn:hover { background: #9A7820 !important; }
